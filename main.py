...
speed = 1
pygame.init()
font = pygame.font.Font("AUSTRALIA-TITLE.otf", 32)
started = False
disSco = 0
PURPLE = (170, 75, 189)
...
class Menu:
    def __init__(self, display, gameStateManager):
        ...
        self.background = pygame.image.load("Cockpit.jpg")
        self.bigFont = pygame.font.Font("AUSTRALIA-TITLE.otf", 95)
        self.smallFont = pygame.font.Font("AUSTRALIA-TITLE.otf", 31)
...
class Options:
    def __init__(self, display, gameStateManager):
        ...
        self.font = pygame.font.Font("AUSTRALIA-TITLE.otf", 75)
